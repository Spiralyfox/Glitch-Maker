...
def _define_plugins():
    ...
    defs = [
        ...
        ("volume",        "U", "#4cc9f0", "Basics",          "volume",        VolumeDialog,       _w_volume),
        ("filter",        "L", "#264653", "Basics",          "filter",        FilterDialog,       _w_filter),
        ("pan",           "⊝", "#2563eb", "Basics",          "pan",           PanDialog,          _w_pan),
        ...
        ("tape_stop",     "X", "#3d5a80", "Pitch & Time",    "tape_stop",     TapeStopDialog,     _w_tape_stop),
        ("autotune",      "♪", "#f72585", "Pitch & Time",    "autotune",      AutotuneDialog,     _w_autotune),
        ("wave_ondulee",  "〰", "#0ea5e9", "Pitch & Time",    "wave_ondulee",  WaveOnduleeDialog,  _w_wave_ondulee),
        ("saturation",    "D", "#ff6b35", "Distortion",      "saturation",    SaturationDialog,   _w_saturation),
        ("distortion",    "W", "#b5179e", "Distortion",      "distortion",    DistortionDialog,   _w_distortion),
        ...
        ("phaser",        "A", "#6d597a", "Modulation",      "phaser",        PhaserDialog,       _w_phaser),
        ("tremolo",       "~", "#e07c24", "Modulation",      "tremolo",       TremoloDialog,      _w_tremolo),
        ("ring_mod",      "M", "#6d597a", "Modulation",      "ring_mod",      RingModDialog,      _w_ring_mod),
        ("delay",         "E", "#2a9d8f", "Space & Texture", "delay",         DelayDialog,        _w_delay),
        ("vinyl",         "V", "#606c38", "Space & Texture", "vinyl",         VinylDialog,        _w_vinyl),
        ("ott",           "O", "#e76f51", "Space & Texture", "ott",           OTTDialog,          _w_ott),
        ("robot",         "🤖","#4a00e0", "Space & Texture", "robot",         RobotDialog,        _w_robot),
        ("hyper",         "⚡","#ff006e", "Space & Texture", "hyper",         HyperDialog,        _w_hyper),
        ("stutter",       "S", "#e94560", "Glitch",          "stutter",       StutterDialog,      _w_stutter),
        ("granular",      "G", "#7b2d8e", "Glitch",          "granular",      GranularDialog,     _w_granular),
        ("shuffle",       "K", "#bb3e03", "Glitch",          "shuffle",       ShuffleDialog,      _w_shuffle),
        ("buffer_freeze", "F", "#457b9d", "Glitch",          "buffer_freeze", BufferFreezeDialog,  _w_buffer_freeze),
        ("datamosh",      "Z", "#9b2226", "Glitch",          "datamosh",      DatamoshDialog,     _w_datamosh),
        ("vocal_chop",    "✂", "#7209b7", "Glitch",          "vocal_chop",    VocalChopDialog,    _w_vocal_chop),
        ("tape_glitch",   "📼","#6b705c", "Glitch",          "tape_glitch",   TapeGlitchDialog,   _w_tape_glitch),
    ]
    plugins = {}
